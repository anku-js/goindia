  ...
  return (
    <section className="fixed bg-[#1f3a61] text-white min-h-screen w-1/2 z-10 lg:relative lg:w-[40%] text-[14px] lg:text-[20px]">
      ...
      <div className="py-4 border-t-2 border-slate-500 ">
        <ul>
          <li
            className={`flex items-center justify-between px-4 py-2.5 lg:px-6 lg:py-2.5 hover:bg-[#2d486e] ${
          ...
          <li
            className={`flex gap-3 px-4 py-2.5 lg:px-6 lg:py-2.5 hover:bg-[#2d486e] items-center ${
          ...
          <li className="flex gap-3 px-4 py-2.5 lg:px-6 lg:py-2.5 hover:bg-[#2d486e]">
